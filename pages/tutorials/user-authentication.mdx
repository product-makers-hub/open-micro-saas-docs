---
title: Authentication tutorial for Open Micro SaaS, the Next.js SaaS template
description: Learn how to set up user authentication in Open Micro SaaS, the Next.js SaaS template, using next-auth.
---
...
Magic link authentication requires an SMTP server to send emails. We highly recommend [Resend](https://resend.com/overview) service, which provides up to 3,000 emails per month free and is easy to use.
...
To learn more deeply how to configure your SMTP server, please refer to the [email configuration tutorial](/tutorials/email-configuration).
