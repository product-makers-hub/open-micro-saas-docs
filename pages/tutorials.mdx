---
title: Tutorials for Open Micro SaaS, the Next.js SaaS template
description: Get started with Open Micro SaaS by following our tutorials. Learn how to configure email, set up user authentication, customize the landing page, and integrate Stripe for payments.
---
...
We recommend you start with this order:
...
Explore the [features](/features) to learn more about what Open Micro SaaS has to offer.
